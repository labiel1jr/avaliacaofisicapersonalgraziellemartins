...
three.js (r128) — modelo 3D.
html2canvas — captura da ficha para imagem.
...
Faça upload do index.html para a raiz do repositório (substituindo o existente, se houver).
Em Settings → Pages, configure Source como Deploy from a branch, branch main, pasta / (root).
Aguarde 1–3 minutos — o link é atualizado automaticamente a cada novo commit.
💾 Onde ficam os dados
